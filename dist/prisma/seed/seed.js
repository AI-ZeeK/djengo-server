...
const roles = [
    ...
    },
    {
        ...
        description: 'Works under a company or agency to manage day-to-day operations.',
    },
    {
        role_name: enum_1.ROLES_ENUM.AGENCY,
...
const file_entity_types = [
    {
        ...
        description: 'Profile pictures for individual users, displayed in profiles, chat interfaces, and reviews.',
...
const address_entity_types = [
    {
        ...
        description: 'Primary residential address where clients receive services such as cleaning, repairs, or maintenance. Used for accurate service scheduling and pricing calculations.',
        max_addresses_per_entity: 1,
        is_active: true,
    },
    {
        entity_type: enum_1.ADDRESS_TYPE_ENUM.USER_WORK,
        description: "Secondary address for service delivery at client's workplace, useful for commercial cleaning, maintenance, or professional services during business hours.",
        max_addresses_per_entity: 3,
        is_active: true,
    },
    {
        entity_type: enum_1.ADDRESS_TYPE_ENUM.BUSINESS_PRIMARY,
        description: 'Main business location for service provider companies, serving as headquarters for operations, staff management, and client meetings.',
        max_addresses_per_entity: 1,
        is_active: true,
    },
    {
...
const platform_roles = [
    ...
    {
        role_name: 'ADMIN',
        description: 'Manages platform-level features (e.g., user management, analytics).',
    },
    {
        role_name: 'SUPPORT_STAFF',
        description: 'Handles customer support and resolves platform-related issues.',
    },
    {
        role_name: 'AUDITOR',
        description: 'Reviews platform data for compliance and security. Read-only access.',
    },
    {
        role_name: 'DEVELOPER',
...
const platform_permissions = [
    ...
    },
    {
        ...
        description: 'Can manage platform finances (e.g., payments, subscriptions).',
    },
